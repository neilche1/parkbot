...
RENT_MANAGER_LOCATION_ID = os.getenv("RENT_MANAGER_LOCATION_ID", "1")  # Default to 1 if not set
...
def fetch_tenants_from_rent_manager():
    ...
    try:
        ...
        for tenant in tenants_data:
            ...
            phone_numbers = tenant.get("phone_numbers", [])
            ...
            for phone in phone_numbers:
                phone_to_tenant[phone] = tenant_key
