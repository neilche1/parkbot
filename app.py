...
# Twilio Credentials
TWILIO_SID = "AC67783e1e6ed7a6fba353ec3fde91b652"
TWILIO_TOKEN = "5d03598576662123298dba271fbce3de"
MESSAGING_SID = "MGfeb018c3e3174b051057f0c0176d395d"
TWILIO_NUMBER = "+19853799364"

# Owner's Phone Number for Notifications
OWNER_PHONE = "+15049090355"

# OpenAI Credentials
OPENAI_KEY = "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"
...
def send_rent_reminders():
    ...
    for tenant_key, tenant in TENANTS.items():
        due_day = int(tenant["due_date"].split()[0])
