...
def authenticate_with_rent_manager():
    ...
    # Temporarily hardcode the token that worked in the portal
...
def fetch_tenants_from_rent_manager():
    ...
    for api_url in RENT_MANAGER_API_URLS:
        ...
        # Use X-RM12Api-Token header
        headers = {
            "X-RM12Api-Token": RENT_MANAGER_API_TOKEN,
            "Content-Type": "application/json; charset=UTF-8"
        }
        try:
            print(f"Fetching tenants with X-RM12Api-Token header: {headers}, params: {params}")
