...
def identify_tenant(input_text):
    ...
    for tenant_key in TENANTS:
        ...
        # Check for matches
        # Match by unit number (flexible matching)
        ...
        elif unit_normalized in input_text_normalized or input_text_normalized in unit_normalized:
            print(f"Match found by unit (partial normalized match): {tenant_key}")
            possible_matches.append(tenant_key)
        # Match by full name
        ...
        # Check for partial matches in name or unit
            ...
            input_has_unit = any(unit_normalized in word.replace(" ", "") for word in input_words)
