...
def identify_tenant(input_text):
    ...
    for tenant_key in TENANTS:
        ...
        # Partial match: input starts with unit and is followed by a space or end of string
        elif (input_text_normalized.startswith(unit_normalized) and 
              (len(input_text_normalized) == len(unit_normalized) or 
               input_text_normalized[len(unit_normalized)] in [' ', ''])):
        ...
        # Fuzzy match with a lower threshold
            ...
            if unit_similarity >= 80:  # Lowered from 90 to 80
