...
def identify_tenant(input_text):
    ...
    for tenant_key in TENANTS:
        ...
        # Match by unit number (partial match, input starts with unit)
            ...
            possible_matches.append(tenant_key)
        # Fuzzy match for unit (e.g., "118 Montegue" vs "118 Monteg")
        else:
            unit_similarity = fuzz.ratio(unit_normalized, input_text_normalized)
            if unit_similarity >= 90:  # 90% similarity threshold
