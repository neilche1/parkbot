...
# Fetch tenant data from Rent Manager API with pagination
...
def identify_tenant(input_text):
    ...
    for tenant_key in TENANTS:
        ...
        print(f"Checking tenant: TenantID={tenant_id}, FullName='{full_name}', Unit='{unit}'")
        ...
        if input_text in first_name_lower or input_text in last_name_lower:
            print(f"Match found by partial first or last name: {tenant_key}")
            possible_matches.append(tenant_key)
